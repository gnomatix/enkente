...
*   **Structured Methodology Support:** The semantic engine must be capable of recognizing and formalizing metadata for established brainstorming methodologies (e.g., *Six Thinking Hats*, *SCAMPER*, *Five Whys*, *Brainwriting*). It must allow ideas to be tagged or structurally routed based on the phase of the process (e.g., separating "generative" ideas from "critical evaluations" or "root cause questions").
